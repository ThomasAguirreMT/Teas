...
const WifiIcon = () => (
  <svg viewBox="0 0 24 24" style={{ width: "38px", height: "38px", fill: "none" }} stroke="rgba(255,255,255,0.25)" strokeWidth="1.5" strokeLinecap="round">
    <path d="M1.5 8.5C6 4 18 4 22.5 8.5" />
    <path d="M5 12c3.9-3.5 11-3.5 14 0" />
    <path d="M8.5 15.5c2-1.8 5-1.8 7 0" />
    <circle cx="12" cy="19" r="1" fill="rgba(255,255,255,0.25)" stroke="none" />
  </svg>
);
