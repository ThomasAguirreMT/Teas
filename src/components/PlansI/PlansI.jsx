...
const WifiIcon = () => (
  <svg viewBox="0 0 24 24" style={{ width: 36, height: 36, fill: "none" }} stroke="rgb(255, 255, 255)" strokeWidth="1.5" strokeLinecap="round">
  ...
  return (
    <section style={{
      ...
      <div style={{ position: "relative", maxWidth: 1160, margin: "0 auto", padding: "0 clamp(16px, 4vw, 40px)" }}>
        ...
        {/* Versión móvil del separador */}
        <div className="flex sm:hidden justify-center" style={{ margin: "24px 0 20px" }}>
          <div style={{
            display: "inline-flex", alignItems: "center", gap: 8,
            ...
            <span style={{ fontSize: "0.65rem", fontWeight: 800, color: "#ff2d6b", letterSpacing: "0.12em", textTransform: "uppercase" }}>
              Para el máximo rendimiento
            </span>
          </div>
        </div>
        ...
        <div
          className="plans-grid grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4"
          style={{ gap: "clamp(12px, 2.5vw, 22px)" }}
        >
          {plans.map((plan, i) => (
